...
CREATE TABLE "product_upvotes" (
	"product_id" bigint,
	"id" uuid,
	CONSTRAINT "product_upvotes_product_id_id_pk" PRIMARY KEY("product_id","id")
);
--> statement-breakpoint
...
ALTER TABLE "gpt_ideas_likes" ADD CONSTRAINT "gpt_ideas_likes_gpt_idea_id_gpt_ideas_idea_id_fk" FOREIGN KEY ("gpt_idea_id") REFERENCES "public"."gpt_ideas"("idea_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
